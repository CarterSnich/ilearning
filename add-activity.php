...
if (isset($_POST['add-activity-button'])) {
    try {
        ...
        if (!$uploadResult['success'] && !empty($_FILES['modulefile']['name'])) {
            ...
            $stmt->bindParam(':2', json_encode($_POST['instructions']));
            $stmt->bindParam(':3', $_FILES['modulefile']['name']);
            $stmt->bindParam(':4', $_POST['maxscore']);
            $stmt->bindParam(':5', $_POST['deadline']);
            $stmt->bindParam(':6', $_POST['status']);

            $stmt->execute();

            redirectToPage("view-activity.php?subj={$_POST['subject']}&id={$conn->lastInsertId()}");
        }
    } catch (\Throwable $th) {
        $_SESSION['REPORT_MSG'] = array(
            'code' => 1,
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="activitytitle" type="text" value="<?= isset($_POST['activitytitle']) ? $_POST['activitytitle'] : '' ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="d-none" id="dummy-delta-container" name="instructions"></textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <div class="profile-upload">
                                            <div class="upload-input">
                                                <input type="file" class="form-control" name="modulefile">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="product_inactive" value="0" required>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="add-activity-button">Create activity</button>
                            </div>
                        </form>
                    </div>
                </div>
